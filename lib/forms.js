...
// XXX doc: trigger a jquery event [type] with parameters [data] on element [el] 
...
// XXX doc: schema is either a function (custom validator) or an array of key-value pairs defining one of the built-in validators.
Forms.validate = function (doc, schema) {
  var tmpl = Template.instance();
  tmpl.errors.remove({});
