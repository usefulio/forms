...
Forms.events = {
  'change, propertyChange': function (e, tmpl) {
    ...
    if (e.isDefaultPrevented() || ! Forms.eventHandlerIsActive(tmpl, 'change'))
      return;
  ...
  , 'submit form': function (e, tmpl) {
    ...
    if (e.isDefaultPrevented() || ! Forms.eventHandlerIsActive(tmpl, 'submit'))
      return;
...
/** Allows to disable and re-enable any of the default Forms package event handlers.
  ...
  * @returns The current status of the event handler (true=active or false=inactive)
  *
